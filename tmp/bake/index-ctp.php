...
?>
                <td class="actions">
                    <CakePHPBakeOpenTag= $this->Html->link(__('Visualizar'), ['action' => 'view', <?= $pk ?>]) CakePHPBakeCloseTag>
                    <CakePHPBakeOpenTag= $this->Html->link(__('Editar'), ['action' => 'edit', <?= $pk ?>]) CakePHPBakeCloseTag>
                    <CakePHPBakeOpenTag= $this->Form->postLink(__('Deletar'), ['action' => 'delete', <?= $pk ?>], ['confirm' => __('Tem certeza de que deseja excluir # {0}?', <?= $pk ?>)]) CakePHPBakeCloseTag>
                </td>
            </tr>
    ...
    <div class="paginator">
        <ul class="pagination">
            <CakePHPBakeOpenTag= $this->Paginator->first('<< ' . __('Primeiro')) CakePHPBakeCloseTag>
            ...
            <CakePHPBakeOpenTag= $this->Paginator->last(__('Último') . ' >>') CakePHPBakeCloseTag>
        </ul>
        <p><CakePHPBakeOpenTag= $this->Paginator->counter(['format' => __('{{page}} / {{pages}}, {{current}} registro(s) de {{count}}')]) CakePHPBakeCloseTag></p>
    </div>
</div>
