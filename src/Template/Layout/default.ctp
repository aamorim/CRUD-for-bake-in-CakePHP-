...
$cakeDescription = 'Intranet - Campus Lagarto';
?>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>A</b>LEX</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>ALEX</b>AMORIM</span>
    </a>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2017 <a href="#">Alex Amorim</a>.</strong> All rights reserved.
  </footer>
